...
if (isset($_POST['add_class'])) {
    ...
    if (!empty($class_name)) {
        ...
        $_SESSION['error'] = "Class name cannot be empty";
    }
...
<head>
    <meta charset="UTF-8">
    <title>Manage Classes - BOA AMPONSEM SHS</title>
            ...
            <div class="card">
                ...
                <form action="classes.php" method="POST">
                    <div class="form-group">
                        <label>Class Name (e.g., 1A1)</label>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="classes.php?delete=<?php echo $class['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
